...
public class solution1
{
    ...
    public solution1(String name, int accountNumber) {
        this(name, accountNumber, "Savings", 0.0);
    }

    // Constructor with all arguments
    public solution1(String name, int accountNumber, String accountType, double balance) {
    ...
    public void display() {
     ...
     // Create an instance of BankAccount with no arguments
        solution1 account1 = new solution1();
